...
It renames all the occurrences of spinal_surgery (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the spinal_surgery folder
        os.rename(
            os.path.join(root_dir_path, "exts", "spinal_surgery", "spinal_surgery"),
            os.path.join(root_dir_path, "exts", "spinal_surgery", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "spinal_surgery"), os.path.join(root_dir_path, "exts", new_name))
