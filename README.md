...
```bash
python -m pip install -e exts/spinal_surgery
```
...
```json
{
    "python.analysis.extraPaths": [
        "<path-to-ext-repo>/exts/spinal_surgery"
    ]
}
```
